<div class="col-12">
    ...
    <div class="tab-content" id="custom-tabs-four-tabContent">
        <div class="tab-pane fade active show" id="custom-tabs-four-uz" role="tabpanel"
            ...
            <div class="form-group">
                <label for="nameInput" class="form-label">Tugma nomi [uz]</label>
                <input type="text" class="form-control" id="nameInput" name="button_label_uz"
                       value="{{old("button_label_uz") ?? $response->getTranslation('button_label','uz')}}">
                @error('button_label_uz')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane fade" id="custom-tabs-four-ru" role="tabpanel"
            ...
            <div class="form-group">
                <label for="nameInput" class="form-label">Tugma nomi [ru]</label>
                <input type="text" class="form-control" id="nameInput" name="button_label_ru"
                       value="{{old("button_label_ru") ?? $response->getTranslation('button_label','ru')}}">
                @error('button_label_ru')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane fade" id="custom-tabs-four-en" role="tabpanel"
            ...
            <div class="form-group">
                <label for="nameInput" class="form-label">Tugma nomi [en]</label>
                <input type="text" class="form-control" id="nameInput" name="button_label_en"
                       value="{{old("button_label_en") ?? $response->getTranslation('button_label','en')}}">
                @error('button_label_en')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            <div class="form-group">
...
<div class="form-group">
    <label for="nameInput" class="form-label">Tugma url manzili</label>
    <input type="text" class="form-control" id="nameInput" name="button_url"
           value="{{old("button_url") ?? $response->button_url}}">
    @error('button_url')
    <span class="text-danger">{{$message}}</span>
    @enderror
</div>
...
<div class="form-group">
    <label for="nameInput" class="form-label">Savol va takliflar bo'yicha telefon raqam</label>
