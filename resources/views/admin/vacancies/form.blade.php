...
<div class="form-group">
    <label for="nameInput" class="form-label">Taklif qilinayotgan oylik maosh</label>
    <input type="text" class="form-control" id="nameInput" name="salary"
           value="{{old("salary") ?? $response->salary}}">
    @error('salary')
    <span class="text-danger">{{$message}}</span>
    @enderror
</div>
