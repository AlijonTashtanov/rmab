...
@endsection
@section('content')
    <x-headers title="{{$response->getTranslation('title','uz')}}" icon="fas fa-circle" parent="Ma'lumotlar"
        ...
        <div class="card-body table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    <th>Fayl</th>
                    <td>
                        <a href="{{ $response->getFileUrl() }}" download=""> {!!$response->getFileUrl() ? "<i class='fas fa-arrow-down'></i> Yuklab
                                olish" : ''!!}</a>
                    </td>
                </tr>
                <tr>
