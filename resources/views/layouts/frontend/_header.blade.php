    ...
    <div class="my-container">
        <div class="navigation-in">
            ...
            <div class="left-nav">
                ...
                <div class="language" style="position: relative;width: auto;">
...
{{--                        <a href="{{ route('change.language', ['locale' => 'uz']) }}"--}}
{{--                           class="txt-16 hov flex flex-col @if( app()->getLocale()=='uz') active @endif">UZ</a>--}}
{{--                        <a href="{{ route('change.language', ['locale' => 'en']) }}"--}}
{{--                           class="txt-16 hov flex flex-col @if( app()->getLocale()=='uz') active  @endif">EN</a>--}}
{{--                        <a href="{{ route('change.language', ['locale' => 'ru']) }}"--}}
{{--                           class="txt-16 hov flex flex-col @if( app()->getLocale()=='uz') active  @endif">RU</a>--}}
{{--                    </div>--}}
                    @if (app()->getLocale() == 'uz')
                        <div class="language-menu">
                            <a href="{{ route('change.language', ['locale' => 'en']) }}" class="txt-16 hov flex flex-col @if( app()->getLocale()=='en') active  @endif">EN</a>
                            <a href="{{ route('change.language', ['locale' => 'ru']) }}" class="txt-16 hov flex flex-col @if( app()->getLocale()=='ru') active  @endif">RU</a>
                        </div>
                    @endif
                    @if (app()->getLocale() == 'ru')
                        <div class="language-menu">
                            <a href="{{ route('change.language', ['locale' => 'uz']) }}" class="txt-16 hov flex flex-col @if( app()->getLocale()=='uz') active @endif">UZ</a>
                            <a href="{{ route('change.language', ['locale' => 'en']) }}" class="txt-16 hov flex flex-col @if( app()->getLocale()=='en') active  @endif">EN</a>
                        </div>
                    @endif
                    @if (app()->getLocale() == 'en')
        ...
        <div class="my-navbar-in">
                    ...
                    <li>
                        ...
                        <ul class="drop-menu">
                            @foreach($pages as $page)
                                @if($page?->getTranslation('title', app()->getLocale()) != '')
                                    @php
                                        $route = '';
                                        if ($page->page_type == '1'){
                                            $route = "page-contract";
            ...
            <div class="nav-left">
                <button class="my-btn txt-16">
                    <a href="{{route('page-contract')}}"> Shartnoma tuzish </a>
                </button>
                <svg
                    class="search hov"
                    xmlns="http://www.w3.org/2000/svg"
