...
<div class="detail-page">
    <div class="my-container">
        <div class="detail-page-in">
            ...
            <div class="my-about">
                <h1 class="txt-33 nav-text">{{ $activeAbout?->getTranslation('title', app()->getLocale()) }}</h1>
                <img
                    src="{{$activeAbout->getImageUrl()}}"
                    alt="aboutInfo?.data?.title"
                />
                <div class="grid-3">
                    <div class="contact-icon">
                        ...
                        <div class="my-text">
                            ...
                            <p class="txt-14">{{ $activeAbout?->getTranslation('address', app()->getLocale()) }}</p>
                        </div>
                    </div>
                    <div class="contact-icon">
                        <div class="icon-bg">
                        ...
                        <div class="my-text">
                            ...
                            <a
                                href="tel:{{$activeAbout->phone}}"
                                target="_blank"
                                class="txt-14 about-phone"
                            >
                           {{$activeAbout->phone}}
                            </a>
                        </div>
                ...
                <p
                    class="txt-18 section-text"

                >
                    {{ $activeAbout?->getTranslation('description', app()->getLocale()) }}</p>
            </div>
        </div>
    </div>
</div>
