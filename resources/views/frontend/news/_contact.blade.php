            ...
            <div class="contact-page">
                ...
                <form action="" class="interactive form">
                    <div class="box">
                        ...
                        <input class="my-input txt-16" type="text" id="name" placeholder="Ismingizni kiritng">

                    </div>
                    <div class="box">
                        <label class="label" for="phone-input">Telefon raqamimiz</label>
                        <input class="aplication-form__input my-input" id="phone-input" placeholder="+998"/>
