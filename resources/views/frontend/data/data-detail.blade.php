            ...
            <div class="detail-content">
                <div class="our-services ">
                    <div class="left-content">
                        <div class="my-about">
                            <h1 class="txt-33 nav-text">{{ $dataDetail?->getTranslation('title', app()->getLocale()) }}</h1>
                            <img src="{{$dataDetail->getImageUrl()}}" alt="image" class="base-img">
                            <div class="txt-18 section-text">
                                {!! $dataDetail?->getTranslation('content', app()->getLocale()) !!}
                            </div>
                        </div>
                    </div>
