                ...
                <div class="language" style="position: relative;width: auto;">
                    ...
                    <?php if(app()->getLocale() == 'uz'): ?>
                        <div class="language-menu">
                            <a href="<?php echo e(route('change.language', ['locale' => 'en'])); ?>" class="txt-16 hov flex flex-col <?php if( app()->getLocale()=='en'): ?> active  <?php endif; ?>">EN</a>
                            <a href="<?php echo e(route('change.language', ['locale' => 'ru'])); ?>" class="txt-16 hov flex flex-col <?php if( app()->getLocale()=='ru'): ?> active  <?php endif; ?>">RU</a>
                        </div>
                    <?php endif; ?>
                    <?php if(app()->getLocale() == 'ru'): ?>
                        <div class="language-menu">
                            <a href="<?php echo e(route('change.language', ['locale' => 'uz'])); ?>" class="txt-16 hov flex flex-col <?php if( app()->getLocale()=='uz'): ?> active <?php endif; ?>">UZ</a>
                            <a href="<?php echo e(route('change.language', ['locale' => 'en'])); ?>" class="txt-16 hov flex flex-col <?php if( app()->getLocale()=='en'): ?> active  <?php endif; ?>">EN</a>
                        </div>
                    <?php endif; ?>
