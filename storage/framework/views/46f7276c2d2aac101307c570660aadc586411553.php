    ...
    <div class="my-container relative">
        ...
        <div class=" BannerSwiper slider-fikr w-100 mt-3 overflow-hidden">
            <div class="swiper-wrapper">
                <?php $__currentLoopData = $activeHomeBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeBanner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <div class="banner-slider-item">
                            <img src="<?php echo e($homeBanner->getImageUrl()); ?>" alt="image">
                        </div>
                    </div>
...
<?php /**PATH C:\OSPanel\domains\rmab-backend\resources\views/frontend/main/_banner-slider.blade.php ENDPATH**/ ?>