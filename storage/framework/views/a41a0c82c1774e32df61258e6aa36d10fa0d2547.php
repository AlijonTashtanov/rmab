                ...
                <div class="detail-content">
                    <div class="our-services">
                        <div class="left-content">
                            <div class="my-about">
                                <h1 class="txt-33 nav-text"><?php echo e($serviseDetail->getTranslation('name', app()->getLocale())); ?></h1>
                                <div class="txt-18 section-text">
                                    <?php echo $serviseDetail->getTranslation('content', app()->getLocale()); ?>
                                    ...
                                    <a href="#" class="vakansia-card vakansia-mini">
                                        ...
                                        <div class="text-blog">
                                            ...
                                            <p class="txt-16 nav-text">
                                                <?php echo e($vacancy->getTranslation('title', app()->getLocale())); ?>
...
<?php echo $__env->make('layouts.frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\rmab-backend\resources\views/frontend/express-detail/index.blade.php ENDPATH**/ ?>