...
use App\Services\CorruptionTypeService;
use Illuminate\Http\RedirectResponse;
use Illuminate\Http\Request;

class CorruptionTypeController extends AbstractController
{
    /**
     * @var string
     */
    protected $dir = 'corruptiontypes';

    /**
     * @var string
     */
    protected $serviceClass = CorruptionTypeService::class;
